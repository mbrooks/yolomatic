...
- Manual repository management in `yeetomatic/admin`: admins can add repositories by owner/name from the repository inventory page via `POST /api/repos`.
...
- `scripts/update-yeetomatic-if-needed.sh` default port updated to `6767`
