...
const mockIssues = [
	{ number: 1, title: "Bug report", body: "desc", state: "open", labels: ["bug", "ui"], assignees: ["mbrooks"], html_url: "https://github.com/mbrooks/tars/issues/1" },
	{ number: 2, title: "Feature request", body: "", state: "open", labels: [], assignees: [], html_url: "https://github.com/mbrooks/tars/issues/2" },
];
