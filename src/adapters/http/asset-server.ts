...
<html lang="en">
	<head>
		...
		<title>Yolomatic Admin</title>
	</head>
	<body>
		<div id="root">Yolomatic Admin assets have not been built.</div>
	</body>
</html>`;
}
...
export function injectAdminConfig(
	...
	const script = `<script>window.__YOLO_ADMIN_PATH__ = ${JSON.stringify(adminPath)}; window.__YOLO_ADMIN_DEFAULT_PAGE__ = ${JSON.stringify(adminDefaultPage)};</script>`;
