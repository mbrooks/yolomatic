...
export const SETTING_DEFINITIONS: SettingDefinition[] = [
	...
	},
	{
		key: "pi_agent_model",
		type: "string",
		description: "Default LLM model identifier (e.g. kimi-k2.7-code:cloud). Used by all worker sessions unless a build or refinement model overrides it.",
		requiresRestart: false,
		sensitive: false,
	...
	},
	{
		...
		type: "string",
		description: "LLM model used for issue build sessions (initial builds, feedback passes, and PR reviews). Falls back to pi_agent_model when unset.",
		requiresRestart: false,
		sensitive: false,
		envVar: "PI_AGENT_BUILD_MODEL",
		category: "ai-llm",
	},
	{
		key: "pi_agent_refinement_model",
		type: "string",
		description: "LLM model used for issue refinement sessions (/yolomatic issue-refinement). Falls back to pi_agent_model when unset.",
		requiresRestart: false,
		sensitive: false,
		envVar: "PI_AGENT_REFINEMENT_MODEL",
		category: "ai-llm",
	},
	{
