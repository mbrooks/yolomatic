...
export const SETTING_DEFINITIONS: SettingDefinition[] = [
	...
	},
	{
		key: "github_username",
		type: "string",
		description: "GitHub username for this Yeetomatic instance",
		requiresRestart: true,
		sensitive: false,
	...
	},
	{
		...
		type: "string",
		description: "GitHub user authorized for /yeetomatic stop (defaults to admin_username)",
		requiresRestart: true,
		sensitive: false,
	...
	},
	{
		...
		requiresRestart: true,
		sensitive: false,
		envVar: "YEETOMATIC_WORKER_WORKSPACE_MOUNT_SOURCE",
		category: "file-system",
	},
	{
		...
		requiresRestart: true,
		sensitive: false,
		envVar: "YEETOMATIC_WORKER_CONTROL_BASE_URL",
		category: "file-system",
	},
	{
		key: "worker_docker_network_mode",
		type: "string",
		description: "Optional docker run --network mode for worker containers (for example container:yeetomatic)",
		requiresRestart: true,
		sensitive: false,
		envVar: "YEETOMATIC_WORKER_DOCKER_NETWORK_MODE",
		category: "file-system",
	},
	{
		key: "default_branch",
	...
	},
	{
		...
		requiresRestart: false,
		sensitive: false,
		envVar: "YEETOMATIC_SELF_REPORT_ENABLED",
	...
	},
	{
		...
		default: "yeetomatic-worker:latest",
		requiresRestart: true,
		sensitive: false,
		envVar: "YEETOMATIC_WORKER_IMAGE",
		category: "agent-behavior",
	},
	{
		...
		requiresRestart: true,
		sensitive: false,
		envVar: "YEETOMATIC_WORKER_OLLAMA_HOST",
		category: "agent-behavior",
	},
	{
